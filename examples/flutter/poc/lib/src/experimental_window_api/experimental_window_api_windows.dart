...
final class WindowsExperimentalWindowPlatformBackend implements ExperimentalWindowPlatformBackend {
  @override
  int nativeWindowHandleAddress(RegularWindowController controller) {
    final windowsController = controller as WindowControllerWin32;
