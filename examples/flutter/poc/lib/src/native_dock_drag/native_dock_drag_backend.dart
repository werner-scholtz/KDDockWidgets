...
abstract base class BaseNativeDockDragPlatformBackend implements NativeDockDragPlatformBackend {
  @override
...
final class UnsupportedNativeDockDragPlatformBackend extends BaseNativeDockDragPlatformBackend {
  @override
  bool registerWindowHandle({required int windowId, required int nativeWindowHandle}) => false;

  @override
  void unregisterWindow({required int windowId}) {}

  @override
  bool attachDragWindow({required int windowId, required int anchorX, required int anchorY}) => false;
